...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/gazette", label: "معالجة أم القرى", d: "M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" },
  { href: "/admin/instruments", label: "الأنظمة وتسلسلها", d: "M12 8v13m0-13V6a2 2 0 012-2h6l-3 3 3 3h-6a2 2 0 01-2-2zm0 0V6a2 2 0 00-2-2H4l3 3-3 3h6a2 2 0 002-2z" },
